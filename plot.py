...
memalign_ok = np.loadtxt('memalign.ok')
memalign_fail = np.loadtxt('memalign.fail')
...
plot(memalign_all, 'memalign (ALL)', axes[0][0])
plot(memalign_fail, 'memalign (FAIL)', axes[0][1])
plot(memalign_ok, 'memalign (OK)', axes[1][0])
